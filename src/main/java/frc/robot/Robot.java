...
public class Robot extends TimedRobot {
	...
	public void teleopPeriodic() {
		...
		if (getFenderPressed()) {
			...
			} else if (!RobotContainer.pointIntakeDrive.isScheduled() && !RobotContainer.autoLift.isScheduled()
					&& !RobotContainer.autoDown.isScheduled() && !RobotContainer.autoMid.isScheduled()
					&& !RobotContainer.autoClose.isScheduled()) {
				autoSchedule(RobotContainer.shooter);
