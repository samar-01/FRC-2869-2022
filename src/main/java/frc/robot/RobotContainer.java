...
public class RobotContainer {
	...
	public static final AutoPointGoal point = new AutoPointGoal(drivetrainSubSys);
	...
	public static final AutoLift autoLift = new AutoLift(angleSubSys, shooterSubSys);
	public static final AutoDown autoDown = new AutoDown(angleSubSys, shooterSubSys);
	public static final AutoMid autoMid = new AutoMid(angleSubSys, shooterSubSys);
